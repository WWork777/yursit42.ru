...
export default function ContactsTextBlock() {
  return (
    <div className={styles.contacts_text_block}>
      ...
      <p>
        <span>Расч. счёт:</span> 40702810310001249585
      </p>
      <p>
        <span>Банк:</span> АО "ТИНЬКОФФ БАНК"
      </p>
      <p>
        <span>ИНН банка:</span> 7710140679
      </p>
      <p>
        <span>БИК банка:</span> 044525974
      </p>
      <p>
        <span>Корр. счет банка:</span> 30101810145250000974
      </p>
      <p>
        <span>Юридический адрес банка:</span> Москва, 127287, ул. Хуторская 2-я,
        д. 38А, стр. 26
      </p>
    </div>
  );

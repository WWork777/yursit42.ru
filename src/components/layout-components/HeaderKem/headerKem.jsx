...
export default function HeaderKem() {
  ...
  const isDarkPage =
    pathname === "/kemerovo/services" ||
    pathname === "/kemerovo/price" ||
    pathname === "/kemerovo/news" ||
    pathname === "/kemerovo/practices" ||
    pathname === "/kemerovo/contacts" ||
    pathname === "/kemerovo/policy" ||
    pathname === "/kemerovo/fiz" ||
    pathname === "/kemerovo/yur" ||
    pathname === "/kemerovo/privacy" ||
    pathname.startsWith("/kemerovo/news/") ||
    pathname.startsWith("/kemerovo/practices/");
...
`}
    >
      <div className={styles.header_logo}>
        <Link href="/kemerovo" onClick={closeMenu}>
      ...
      <div className={`${styles.mobile_menu} ${isMenuOpen ? styles.open : ""}`}>
        ...
        <div className={`${styles.mobile_menu_links}`}>
          ...
          <Link href="/kemerovo/price" onClick={closeMenu}>
            <p
              className={isDarkPage && isScrolled ? styles.darkTextMobile : ""}
            >
              Прайс-лист
          ...
          <Link href="/kemerovo/practices" onClick={closeMenu}>
            <p
              className={isDarkPage && isScrolled ? styles.darkTextMobile : ""}
            >
              Практика
          ...
          <Link href="/kemerovo/novisibirsk/news" onClick={closeMenu}>
            <p
              className={isDarkPage && isScrolled ? styles.darkTextMobile : ""}
            >
              Новости
          ...
          <Link href="/kemerovo/contacts" onClick={closeMenu}>
            <p
              className={isDarkPage && isScrolled ? styles.darkTextMobile : ""}
            >
              Контакты

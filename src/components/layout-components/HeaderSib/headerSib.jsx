...
export default function HeaderSib() {
  ...
  const isDarkPage =
    pathname === "/novosibirsk/services" ||
    pathname === "/novosibirsk/price" ||
    pathname === "/novosibirsk/news" ||
    pathname === "/novosibirsk/practices" ||
    pathname === "/novosibirsk/contacts" ||
    pathname === "/novosibirsk/policy" ||
    pathname === "/novosibirsk/fiz" ||
    pathname === "/novosibirsk/yur" ||
    pathname === "/novosibirsk/privacy" ||
    pathname.startsWith("/novosibirsk/news/") ||
    pathname.startsWith("/novosibirsk/practices/");
...
`}
    >
      <div className={styles.header_logo}>
        <Link href="/novosibirsk/" onClick={closeMenu}>
      ...
      <div className={`${styles.mobile_menu} ${isMenuOpen ? styles.open : ""}`}>
        ...
        <div className={`${styles.mobile_menu_links}`}>
          <Link href="/novosibirsk/fiz" onClick={closeMenu}>
            <p
          ...
          <Link href="/novosibirsk/price" onClick={closeMenu}>
            <p
              className={isDarkPage && isScrolled ? styles.darkTextMobile : ""}
            >
              Прайс-лист
          ...
          <Link href="/novosibirsk/practices" onClick={closeMenu}>
            <p
              className={isDarkPage && isScrolled ? styles.darkTextMobile : ""}
            >
              Практика
          ...
          <Link href="/novisibirsk/news" onClick={closeMenu}>
            <p
              className={isDarkPage && isScrolled ? styles.darkTextMobile : ""}
            >
              Новости
          ...
          <Link href="/novosibirsk/contacts" onClick={closeMenu}>
            <p
              className={isDarkPage && isScrolled ? styles.darkTextMobile : ""}
            >
              Контакты
        ...
        <div className={styles.mobile_contacts_mobile}>
          ...
          >
            ...
            <p onClick={openChangeSiteModal}>Новосибирск</p>
          </div>
        </div>

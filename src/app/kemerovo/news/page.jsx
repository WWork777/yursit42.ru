...
export const metadata = {
  ...
  alternates: {
    canonical: "https://yurist42.ru/kemerovo/news",
  },
  openGraph: {
    title: "Новости юриста Кемерово | Судебная практика и изменения в законах",
    description:
    ...
    url: "https://yurist42.ru/kemerovo/news",
    images: [
      {
        ...
        <div className={styles.newsList}>
          {newsData.map((news) => (
            ...
            >
              ...
              <h2>
                <Link href={`/kemerovo/news/${news.slug}`}>{news.title}</Link>
              </h2>

...
export async function generateMetadata({ params }) {
  ...
  if (!news) {
    return {
      title: "Новость не найдена | yurist42.ru",
      description: "Страница новости не найдена.",
    };
  }

  return {
    title: `${news.seotitle} | Юридические новости в Кемерово`,
    description: news.excerpt,
    keywords: news.keywords,
    alternates: {
      canonical: `https://yurist42.ru/kemerovo/news/${slug}`,
    },
    openGraph: {
      title: news.title,
      description: news.excerpt,
      url: `https://yurist42.ru/kemerovo/news/${slug}`,
      type: "article",
...
export default function NewsPost({ params }) {
  ...
  const breadcrumbs = [
    ...
    { label: "Новости", path: "/kemerovo/news" },
    {
      label:

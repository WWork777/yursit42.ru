...
import Practice from "@/componentsKem/practices-components/practice-list";
...
export const metadata = {
  ...
  alternates: {
    canonical: "https://yurist42.ru/kemerovo/practices",
  },
  openGraph: {
    title: "Практика юристов в Кемерово | Судебные дела и выигранные процессы",
    description:
    ...
    url: "https://yurist42.ru/kemerovo/practices",
    images: [
      {

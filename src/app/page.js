...
export const metadata = {
  title: "Юрист Кемерово | Юридическая компания Кодексъ — помощь, консультации, адвокаты",
  description:
  ...
  keywords:
    "Юрист Кемерово, юрист Кемеровская область, юридическая компания, бесплатная консультация юриста, помощь юриста, юрист по банкротству, адвокат, договор юрист, судебный юрист, лучшие юристы, юридическое бюро, юридическая контора, консультация юриста Кемерово",
  alternates: {

...
export const metadata = {
  title:
    "Новости юриста | Судебная практика и изменения в законах",
  description:
    "Юридические новости: актуальные изменения в законодательстве, судебная практика, права граждан и бизнеса. Комментарии и консультации юристов компании «Кодексъ».",
  keywords:
    "новости юриста , юридические новости, судебная практика, изменения в законах 2025, права граждан, новости для бизнеса, консультация юриста, юридический центр, лучшие юристы ",
  alternates: {
    canonical: "https://yurist42.ru/news",
  },
  openGraph: {
    title: "Новости юриста | Судебная практика и изменения в законах",
    description:
      "Актуальные новости юриспруденции: изменения в законах, судебная практика, права граждан и бизнеса. Комментарии и консультации юристов «Кодексъ».",
    url: "https://yurist42.ru/news",
    images: [
      {
        url: "/favicon/favicon-96x96.png",
        alt: "Новости юриста в - yurist42.ru",
      },
    ],
  },
};

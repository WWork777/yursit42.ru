...
export default function Policy() {
  return (
    <section className="section-main secondary-page">
      <h3 className={styles.policy_title}>1. Общие положения</h3>
      <p>
        ...
        данных и меры по обеспечению безопасности персональных данных ООО
        "ИНТЕЛЛЕКТ КАПИТАЛЪ" (далее – Оператор).
      </p>{" "}
      <br />
      <p>
      ...
      <p>
        ...
        <br />
        <u>
          <a href="https://yurist42.ru/novosibirsk">https://yurist42.ru;</a>
        </u>
        <a href="https://yurist42.ru/novosibirsk"></a>
      </p>
      <a href="https://yurist42.ru/novosibirsk">
        <h3 className={styles.policy_title}>
      ...
      <p>
        ...
        <br />
        <u>
          <a href="https://yurist42.ru">https://yurist42.ru/novosibirsk;</a>
        </u>
        <a href="https://yurist42.ru"></a>
      </p>
      <a href="https://yurist42.ru">
        <p>
      ...
      <p>
        ...
        Пользователя посредством обратного звонка.
      </p>
      <br />
      <p>
      ...
      <p>
        ...
        <u>
          <a href="https://nsk.yurist42.ru/novosibirsk">
            https://nsk.yurist42.ru/novosibirsk
          </a>
        </u>
      ...
      <br />
      <h3 className={styles.policy_title}>8. Заключительные положения</h3>
      <p>
      ...
      <p>
        ...
        Интернет по адресу
        <u>
          <a href="https://yurist42.ru/novosibirsk/privacy">
            https://yurist42.ru/privacy/novosibirsk
          </a>
        </u>
        .
      </p>

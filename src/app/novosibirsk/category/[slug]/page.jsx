...
import servicesData from "@/dataNsk/gr-all-services.json";
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://yurist42.ru/novosibirsk/category/${params.slug}`,
    },
    openGraph: {
      title: service.titleSeo || service.title,
      description: service.descriptionSeo || service.description,
      url: `https://yurist42.ru/novosibirsk/category/${params.slug}`,
      images: [
        {
...
export default function Page({ params }) {
  ...
  const breadcrumbs = [
    ...
    {
      label: "Услуги физическим лицам",
      path: "/novosibirsk/services?type=gr",
    },
    { label: service.title },
  ];
  return (
